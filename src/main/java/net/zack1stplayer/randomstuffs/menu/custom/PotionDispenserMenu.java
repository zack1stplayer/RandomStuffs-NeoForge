...
public class PotionDispenserMenu extends AbstractContainerMenu {
    ...
    public PotionDispenserMenu(int containerId, Inventory inv, BlockEntity blockEntity, ContainerData dataAccess) {
        super(ModMenuTypes.POTION_DISPENSER_MENU.get(), containerId);
        this.blockEntity = (PotionDispenserBlockEntity) blockEntity;
